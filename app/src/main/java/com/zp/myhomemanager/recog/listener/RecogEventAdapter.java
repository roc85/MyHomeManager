package com.zp.myhomemanager.recog.listener;

import android.util.Log;

import com.baidu.speech.EventListener;
import com.baidu.speech.asr.SpeechConstant;
import com.zp.myhomemanager.recog.RecogResult;
    ...
    public void onEvent(String name, String params, byte[] data, int offset, int length) {
        ...
        if (name.equals(SpeechConstant.CALLBACK_EVENT_ASR_LOADED)) {
            ...
            if (data.length != length) {
                MyLog.e(TAG, "internal error: asr.audio callback data length is not equal to length param");
            }
